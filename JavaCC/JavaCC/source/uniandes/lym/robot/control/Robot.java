...
//boolean command(uniandes.lym.robot.view.Console sistema) :
  ...
  final public void direccion() throws ParseException {
    if (jj_2_54(2)) {
  ...
  final public void orient() throws ParseException {
    if (jj_2_65(2)) {
      jj_consume_token(NORTH);
    } else if (jj_2_66(2)) {
      jj_consume_token(SOUTH);
  ...
  final public int valor() throws ParseException {
        int val = 0;
    if (jj_2_69(2)) {
      jj_consume_token(NUM);
      ...
      jj_consume_token(NOMBRE);
                     val = obtenerValorVariable(token.image);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public void listaDir() throws ParseException {
    dirMoves();
    label_4:
    while (true) {
      if (jj_2_73(2)) {
  ...
  final public void dirMoves() throws ParseException {
    if (jj_2_74(2)) {
  ...
  private boolean jj_3_51() {
    if (jj_scan_token(ISFACING)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }

  private boolean jj_3_50() {
    if (jj_scan_token(ISBLOCKED)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }
  ...
  private boolean jj_3_35() {
    if (jj_scan_token(SAFEEXE)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }
  ...
  private boolean jj_3_33() {
    if (jj_scan_token(MOVES)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }
  ...
  private boolean jj_3_25() {
    if (jj_scan_token(TURNTOTHE)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }

  private boolean jj_3_24() {
    if (jj_scan_token(TURNTOMY)) return true;
    if (jj_scan_token(59)) return true;
    return false;
  }
  ...
  private boolean jj_3_77() {
    if (jj_scan_token(BACKWARDS)) return true;
    return false;
  }
